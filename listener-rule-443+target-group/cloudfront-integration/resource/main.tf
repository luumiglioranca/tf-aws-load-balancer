...
#########################################################################################
#                                                                                       #                                 
#                          LOAD BALANCER HTTP LISTENER RULE (80)                        #
#                                                                                       #                                 
#########################################################################################

resource "aws_lb_listener_rule" "listener_http" {
  ...
  dynamic "condition" {
    ...
    content {
      dynamic "http_header" {
        for_each = length(keys(lookup(condition.value, "http_header", {}))) == 0 ? [] : [lookup(condition.value, "http_header", {})]
        content {
...
#########################################################################################
#                                                                                       #                                 
#                         LOAD BALANCER HTTPS LISTENER RULE (443)                       #
#                                                                                       #                                 
#########################################################################################
